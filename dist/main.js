...
var _evancz$elm_todomvc$About$view = _elm_lang$html$Html$text('This is the about page');

var _evancz$elm_todomvc$Route$urlFor = function (loc) {
	var url = function () {
		var _p0 = loc;
		switch (_p0.ctor) {
			case 'Home':
...
var _evancz$elm_todomvc$Route$init = function (location) {
	return location;
};
var _evancz$elm_todomvc$Route$Topic = function (a) {
	return {ctor: 'Topic', _0: a};
};
var _evancz$elm_todomvc$Route$Topics = {ctor: 'Topics'};
var _evancz$elm_todomvc$Route$Home = {ctor: 'Home'};
var _evancz$elm_todomvc$Route$locFor = function (path) {
	var segments = A2(
	...
	do {
		if (_p1.ctor === '[]') {
			return _elm_lang$core$Maybe$Just(_evancz$elm_todomvc$Route$Home);
		} else {
			if (_p1._0 === 'topics') {
				if (_p1._1.ctor === '[]') {
					return _elm_lang$core$Maybe$Just(_evancz$elm_todomvc$Route$Topics);
				} else {
					if (_p1._1._1.ctor === '[]') {
						return _elm_lang$core$Maybe$Just(
							_evancz$elm_todomvc$Route$Topic(_p1._1._0));
					} else {
						break _v1_3;
					}
				}
...
var _evancz$elm_todomvc$Helpers$link = function (_p0) {
	var _p1 = _p0;
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_evancz$elm_todomvc$Route$urlFor(_p1._0))
			]),
		_elm_lang$core$Native_List.fromArray(
			[
...
var _evancz$elm_todomvc$Topic$fakeTopics = _elm_lang$core$Native_List.fromArray(
	[
		{id: 1, title: 'Elixir', slug: 'elixir'},
		{id: 2, title: 'Elm', slug: 'elm'}
	]);
var _evancz$elm_todomvc$Topic$viewTopic = F2(
	function (slug, topics) {
		var currentTopic = _elm_lang$core$List$head(
			A2(
				_elm_lang$core$List$filter,
				function (t) {
					return _elm_lang$core$Native_Utils.eq(t.slug, slug);
				},
				topics));
		var _p0 = currentTopic;
		if (_p0.ctor === 'Nothing') {
			return _elm_lang$html$Html$text('Nothing to see here');
		} else {
			return _elm_lang$html$Html$text(
				A2(
					_elm_lang$core$Basics_ops['++'],
					'This is the ',
					A2(_elm_lang$core$Basics_ops['++'], _p0._0.slug, ' topic')));
		}
	});
var _evancz$elm_todomvc$Topic$topicListItemView = function (topic) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_evancz$elm_todomvc$Helpers$link(
				{
					ctor: '_Tuple2',
					_0: _evancz$elm_todomvc$Route$Topic(topic.slug),
					_1: topic.title
				})
			]));
};
var _evancz$elm_todomvc$Topic$view = function (topics) {
	return A2(
		_elm_lang$html$Html$ul,
		_elm_lang$core$Native_List.fromArray(
			[]),
		A2(_elm_lang$core$List$map, _evancz$elm_todomvc$Topic$topicListItemView, topics));
};
var _evancz$elm_todomvc$Topic$Topic = F3(
	function (a, b, c) {
		return {id: a, title: b, slug: c};
	});

var _evancz$elm_todomvc$Main$updateRoute = F2(
...
var _evancz$elm_todomvc$Main$links = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: _evancz$elm_todomvc$Route$Home, _1: 'Home'},
		{ctor: '_Tuple2', _0: _evancz$elm_todomvc$Route$Topics, _1: 'Topics'}
	]);
var _evancz$elm_todomvc$Main$navigationView = function (model) {
	var linkListItem = function (linkData) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_evancz$elm_todomvc$Helpers$link(linkData)
				]));
	};
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[]),
				A2(_elm_lang$core$List$map, linkListItem, _evancz$elm_todomvc$Main$links))
			]));
};
var _evancz$elm_todomvc$Main$view = function (model) {
	var body = function () {
		...
		if (_p0.ctor === 'Just') {
			switch (_p0._0.ctor) {
				case 'Home':
					return _evancz$elm_todomvc$About$view;
				case 'Topics':
					return _evancz$elm_todomvc$Topic$view(_evancz$elm_todomvc$Topic$fakeTopics);
				default:
					return A2(_evancz$elm_todomvc$Topic$viewTopic, _p0._0._0, _evancz$elm_todomvc$Topic$fakeTopics);
			}
		} else {
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_evancz$elm_todomvc$Main$navigationView(model),
				body
			]));
};
var _evancz$elm_todomvc$Main$subscriptions = function (_p1) {
	return _elm_lang$core$Platform_Sub$none;
};
...
var _evancz$elm_todomvc$Main$init = function (location) {
	var route = _evancz$elm_todomvc$Route$init(location);
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		{route: route},
		_elm_lang$core$Native_List.fromArray(
...
var _evancz$elm_todomvc$Main$main = {
	main: A2(
		...
		_elm_lang$navigation$Navigation$makeParser(_evancz$elm_todomvc$Route$locFor),
		{init: _evancz$elm_todomvc$Main$init, update: _evancz$elm_todomvc$Main$update, urlUpdate: _evancz$elm_todomvc$Main$updateRoute, subscriptions: _evancz$elm_todomvc$Main$subscriptions, view: _evancz$elm_todomvc$Main$view})
};
var _evancz$elm_todomvc$Main$Model = function (a) {
	return {route: a};
};
