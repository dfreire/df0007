...
var _evancz$elm_todomvc$MyApp$model = 0;
...
var _evancz$elm_todomvc$MyApp$main = {
	main: _elm_lang$html$Html_App$beginnerProgram(
		{model: _evancz$elm_todomvc$MyApp$model, view: _evancz$elm_todomvc$MyApp$view, update: _evancz$elm_todomvc$MyApp$update})
};

var Elm = {};
Elm['MyApp'] = Elm['MyApp'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['MyApp'], 'MyApp', typeof _evancz$elm_todomvc$MyApp$main === 'undefined' ? null : _evancz$elm_todomvc$MyApp$main);
